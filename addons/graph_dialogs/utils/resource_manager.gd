class_name GraphDialogsResourceManager
extends Node
...
func _enter_tree() -> void:
	...
	_portraits_canvas = _new_canvas_layer(
		"PortraitsCanvas", GraphDialogsSettings.get_setting("portraits_canvas_layer"))
	_dialog_boxes_canvas = _new_canvas_layer(
		"DialogBoxCanvas", GraphDialogsSettings.get_setting("dialog_box_canvas_layer"))
