...
var error_template = preload(
	"res://addons/graph_dialogs/editor/modules/workspace/components/error_alert.tscn"
	)
## Templates for warning alert
var warning_template = preload(
	"res://addons/graph_dialogs/editor/modules/workspace/components/warning_alert.tscn"
	)
