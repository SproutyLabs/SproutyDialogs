...
## File manager
##
## This script handles the files management for the Graph Dialogs editor.
...
var _new_char_icon := preload("res://addons/graph_dialogs/icons/add-char.svg")

## Prefab scenes reference
var _graph_scene := preload("res://addons/graph_dialogs/editor/modules/workspace/graph.tscn")
var _char_scene := preload("res://addons/graph_dialogs/editor/modules/characters/character_editor.tscn")
...
func _new_graph_from_resource(resource: GraphDialogsDialogueData) -> GraphEdit:
...
func _new_character_from_resource(resource: GraphDialogsCharacterData) -> Control:
...
func on_open_file_pressed() -> void:
	open_file_dialog.set_current_dir(GraphDialogsFileUtils.get_recent_file_path("graph_dialogs_files"))
	open_file_dialog.popup_centered()


## Create new dialog file
func on_new_dialog_pressed() -> void:
	new_dialog_file_dialog.set_current_dir(GraphDialogsFileUtils.get_recent_file_path("dialogue_files"))
	new_dialog_file_dialog.popup_centered()


## Create new character file
func on_new_character_pressed() -> void:
	new_char_file_dialog.set_current_dir(GraphDialogsFileUtils.get_recent_file_path("character_files"))
