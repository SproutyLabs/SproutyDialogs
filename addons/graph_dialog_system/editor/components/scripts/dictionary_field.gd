@tool
class_name GraphDialogsDictionaryField
...
var _item_field := preload("res://addons/graph_dialog_system/editor/components/dictionary_field_item.tscn")
...
func _new_dictionary_item() -> GraphDialogsDictionaryFieldItem:
