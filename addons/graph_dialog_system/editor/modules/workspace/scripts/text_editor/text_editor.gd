...
var expand_icon: Texture = preload("res://addons/graph_dialog_system/icons/interactable/collapse-up.svg")
var collapse_icon: Texture = preload("res://addons/graph_dialog_system/icons/interactable/collapse-down.svg")
