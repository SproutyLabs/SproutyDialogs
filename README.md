...
<p>A graph-based visual dialogue system plugin for Godot 4.5+ to creating conversations and sequences in your games incredibly easy!</p>
</div>
...
<div align="center">
 ...
 <a href="https://ko-fi.com/kazymila" target="_blank" style="text-decoration:none"><img alt="Ko-fi Badge" src="https://img.shields.io/badge/Support_me-salmon?logo=kofi&labelColor=%23ffff">
</a>
<h3></h3>
</div>
...
You can follow the installation instructions from the [installation guide](https://SproutyLabs.github.io/SproutyDialogsDocs/docs/getting-started/installation) in the documentation.
...
- **Variables support** to condicional branching, parse variables and more!
- **Signals support** to trigger events from your dialogues
- **Custom event nodes support** to create you own events for your game
- **Translations support** using `.tres` files or CSV files
- **Edit translations in the editor** without leave the engine
- **And preview your dialogues** directly in the editor!

## Documentation

You can see the [documentation](https://SproutyLabs.github.io/SproutyDialogsDocs) for learn more about Sprouty Dialogs and all its features!

There is a [getting started](https://SproutyLabs.github.io/SproutyDialogsDocs/docs/category/getting-started) section, where you can learn how to start making your dialogues!

Also, you have a [class reference](https://SproutyLabs.github.io/SproutyDialogsDocs/docs/category/class-reference) is you need it.
...
This project is licensed under the terms of the [MIT license](https://github.com/SproutyLabs/SproutyDialogs/blob/main/LICENSE). *It's completely free forever!*

If you want to support my work, and future plugins, you can support me on ko-fi! ♡

<p align='center'><a href='https://ko-fi.com/kazymila'><img src='https://ko-fi.com/img/githubbutton_sm.svg'/></a></p>
